---
title: 'Sucursal - La Libertad'
description: 'Es la sede de nuestra filial en La Libertad, ubicada en la ciudad de Trujillo. Esta sucursal se encarga de atender a nuestros clientes en la región, ofreciendo servicios personalizados y soluciones adaptadas a sus necesidades específicas.'
pubDate: 'Oct 9 2025'
heroImage: '../../assets/LaLibertad.jpg'
---

### Topología Física y Lógica de la red (La Libertad)

![alt text](../../../public/LaLibertad-Sede.png)

##### Nombre: Sucursal 1 - La Libertad
##### Dirección IP: 172.21.44.0/22
